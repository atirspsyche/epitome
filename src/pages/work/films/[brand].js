...
import data from "../../../data/short-film-data.json";
  ...
  return (
    <main className="relative overflow-x-hidden cursor-none">
      ...
      <div className="relative grid md:grid-cols-2 bg-primary z-10 px-8 py-16 gap-10">
        <div>
          <div className="font-heading text-3xl uppercase bg-clip-text leading-tight text-transparent bg-gradient-to-tr  from-hanBlue to-coralRed">
            About Project
          </div>
